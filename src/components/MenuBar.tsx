...
import { FileText, CheckSquare, Calendar, Settings, SlidersHorizontal, TerminalSquare } from 'lucide-react'
...
function MenuBar({ isOpen, settings, onOpenSettings, onOpenTerminal, onOpenExplorer }: MenuBarProps) {
  ...
  const quickActions = [
    ...
    {
      label: 'Terminal',  icon: <TerminalSquare size={20} />, color: 'text-amber-400',
    ...
    <>
      ...
      >
        ...
        <div className="flex justify-center pt-6 py-6 pb-2 relative">
          ...
          {/* ── Main Grid ─────────────────────────────────────────────── */}
          <div className="grid grid-cols-4 min-h-55 w-[70%]">
            ...
            <div className="px-4 py-8 min-w-0 w-full">
              ...
              <div className="flex flex-col gap-2.5">
                {quickActions.map(action => (
                  ...
                  >
                    <div className={`w-7 h-7 flex items-center justify-center shrink-0 ${action.color}`}>
                      {action.icon}
                    </div>
